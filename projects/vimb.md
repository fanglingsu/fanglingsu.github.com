...
new written code base that consequently uses the high-level functions provided
...
even if the features will be implemented in future. So [vimb][] the vim-like
webkit browser was born.
...
a consequent way like it's know from [Suckless][] project.

Further information can be found on the [vimb project page][vimb].
